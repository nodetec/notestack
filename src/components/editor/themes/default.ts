...
const theme: EditorThemeClasses = {
  ...
  quote: 'border-l-4 mb-6 border-primary/30 pl-4 italic text-muted-foreground last:mb-0',
  heading: {
    h1: 'text-3xl font-bold mb-6',
    h2: 'text-2xl font-bold mb-6',
    h3: 'text-xl font-bold mb-6',
    h4: 'text-lg font-bold mb-6',
    h5: 'text-base font-bold mb-6',
    h6: 'text-sm font-bold mb-6',
  },
  list: {
    nested: {
      listitem: 'list-none',
    },
    ol: 'list-decimal ml-6 mb-6',
